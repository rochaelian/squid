...
/**
 * REST controller for managing {@link com.manati.squid.domain.Transaction}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TransactionResource {
    ...
    public ResponseEntity<Transaction> updateTransaction(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(false, ENTITY_NAME, "", transaction.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Transaction> partialUpdateTransaction(
            ...
            .map(
                existingTransaction -> {
                    ...
                    if (transaction.getCost() != null) {
                        existingTransaction.setCost(transaction.getCost());
                    }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(false, ENTITY_NAME, "", transaction.getId().toString())
        );
    }
