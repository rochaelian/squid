...
import com.manati.squid.repository.LocationRepository;
...
/**
 * REST controller for managing {@link com.manati.squid.domain.Location}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class LocationResource {
    ...
    public ResponseEntity<Location> updateLocation(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(false, ENTITY_NAME, "", location.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Location> partialUpdateLocation(
        ...
        Optional<Location> result = locationRepository
            ...
            .map(
                existingLocation -> {
                    ...
                    if (location.getCanton() != null) {
                        existingLocation.setCanton(location.getCanton());
                    }
                    if (location.getDistrict() != null) {
                        existingLocation.setDistrict(location.getDistrict());
                    }
                    if (location.getLatitud() != null) {
                        existingLocation.setLatitud(location.getLatitud());
                    }
                    if (location.getLongitude() != null) {
                        existingLocation.setLongitude(location.getLongitude());
                    }
                    if (location.getExactLocation() != null) {
                        existingLocation.setExactLocation(location.getExactLocation());
                    }
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(false, ENTITY_NAME, "", location.getId().toString()));
    }
